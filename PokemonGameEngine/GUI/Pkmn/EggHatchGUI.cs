            ...
            switch (_state)
            {
                ...
                case State.AnEggIsHatchingMsg:
                {
                    if (ReadMessage())
                    {
                        ...
                        _stringPrinter = null;
                        _fadeTransition = new FadeToColorTransition(60, RenderUtils.ColorNoA(255, 255, 255));
                ...
                case State.FadeToWhite:
                {
                    if (_fadeTransition.IsDone)
                    {
                        ...
                        _pkmn.HatchEgg();
                        LoadPkmnImage();
                        _fadeTransition = new FadeFromColorTransition(60, RenderUtils.ColorNoA(255, 255, 255));
