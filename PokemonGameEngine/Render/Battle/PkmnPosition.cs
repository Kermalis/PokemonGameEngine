        ...
        public static PkmnPosition[][] CreatePositions(PBEBattleFormat f)
        {
            ...
            switch (f)
            {
                case PBEBattleFormat.Single:
                {
                    ...
                    {
                        new PkmnPosition(new Vector3( 0.00f, floorY,   2.0f), new Vector2(0.04100f, 0.05400f), new Vector2(0.015f, 0.25f))  // Center (cam dist sqrd = 263.5625)
                    };
                    a[1] = new PkmnPosition[1]
                    {
                        new PkmnPosition(new Vector3( 0.75f, floorY, -12.0f), new Vector2(0.03660f, 0.04800f), new Vector2(0.10f, 0.015f))  // Center (cam dist sqrd = 813.6250)
                    };
                    break;
                }
                case PBEBattleFormat.Double:
                {
                    ...
                    {
                        new PkmnPosition(new Vector3(-1.50f, floorY,   1.5f), new Vector2(0.04370f, 0.05750f), new Vector2(0.015f, 0.250f)), // Left  (cam dist sqrd = 300.0625)
                        new PkmnPosition(new Vector3( 2.25f, floorY,   1.5f), new Vector2(0.04010f, 0.05300f), new Vector2(0.295f, 0.270f))  // Right (cam dist sqrd = 250.3750)
                    };
                    a[1] = new PkmnPosition[2]
                    {
                        new PkmnPosition(new Vector3( 1.75f, floorY, -12.5f), new Vector2(0.03671f, 0.04860f), new Vector2(0.380f, 0.035f)), // Left  (cam dist sqrd = 829.3750)
                        new PkmnPosition(new Vector3(-1.75f, floorY, -12.5f), new Vector2(0.03835f, 0.05040f), new Vector2(0.100f, 0.015f))  // Right (cam dist sqrd = 878.3750)
                    };
                    break;
                }
                case PBEBattleFormat.Triple:
                {
                    ...
                    {
                        new PkmnPosition(new Vector3(-2.00f, floorY,   1.0f), new Vector2(0.04540f, 0.05980f), new Vector2(0.015f, 0.25f)), // Left   (cam dist sqrd = 322.5625)
                        new PkmnPosition(new Vector3( 0.50f, floorY,  -0.5f), new Vector2(0.04646f, 0.06120f), new Vector2(0.295f, 0.27f)), // Center (cam dist sqrd = 328.0625)
                        new PkmnPosition(new Vector3( 3.25f, floorY,   1.0f), new Vector2(0.04030f, 0.05310f), new Vector2(0.575f, 0.29f))  // Right  (cam dist sqrd = 255.6250)
                    };
                    a[1] = new PkmnPosition[3]
                    {
                        new PkmnPosition(new Vector3( 3.25f, floorY, -12.5f), new Vector2(0.03600f, 0.04730f), new Vector2(0.66f, 0.055f)), // Left   (cam dist sqrd = 815.8750)
                        new PkmnPosition(new Vector3( 0.75f, floorY, -11.0f), new Vector2(0.03550f, 0.04700f), new Vector2(0.38f, 0.035f)), // Center (cam dist sqrd = 760.6250)
                        new PkmnPosition(new Vector3(-2.75f, floorY, -12.5f), new Vector2(0.03880f, 0.05150f), new Vector2(0.10f, 0.015f))  // Right  (cam dist sqrd = 896.8750)
                    };
                    break;
                }
